...
class StoreController extends Controller{
    ...
    public function actionIndex(){
        ...
        $countSql = " SELECT storeID FROM Estate_Store r,Estate_BasicInfo b WHERE r.estateID = b.estateID AND b.status = 2";
        ...
        foreach ($dataArr as $val){
            ...
            foreach ($val as $v){
                $residentialBuildingIds[]= $v['storeID'];
            }
            $house = House::getInstance();
            $res = $house->addRecordStore($residentialBuildingIds);
            print_r($res);
        }
