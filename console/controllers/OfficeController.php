...
class OfficeController extends Controller{
    ...
    public function actionIndex(){
        ...
        $countSql = " SELECT officeID FROM Estate_Office r,Estate_BasicInfo b WHERE r.estateID = b.estateID AND b.status = 2";
        ...
        foreach ($dataArr as $val){
            ...
            foreach ($val as $v){
                $residentialBuildingIds[]= $v['officeID'];
            }
            $house = House::getInstance();
            $res = $house->addRecordOffice($residentialBuildingIds);
            print_r($res);
        }
