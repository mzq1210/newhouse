...
class LoupanController extends ActiveController
{
    ...
    public function actionIndex()
    {
        try {
            ...
            lastAveragePrice,lastRoomMinPrice,isJudge,undetermined,minBuildArea,maxBuildArea,tagList,propertyTypeName,propertyTypeChildName,majorHouseType,collaborationType,totalSeeHouseReviewCount,pageViewCount';
            $info = $model->searchs($page, $pageSize, $model->companyCode, SOLR_ZHUZHAI, $fields);
            $results = [];
