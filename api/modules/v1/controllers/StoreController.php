...
class StoreController extends ActiveController{
    ...
    public function actionIndex(){
        try {
            ...
            lastAveragePrice,lastRoomMinPrice,isJudge,undetermined,minBuildArea,maxBuildArea,tagList,propertyTypeName,collaborationType,propertyTypeChildName,totalSeeHouseReviewCount,standardFloorArea,pageViewCount';
            $info = $model->searchs($page, $pageSize, $model->companyCode, SOLR_STORE, $fields);
            $results = [];
